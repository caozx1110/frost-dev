...
MATH_VER = '13.0';  %NOTE: change it to currently installed Wolfram Mathematica version
...
elseif ispc %NOTE: add `ws_link_dir` (get below) and the system uses path
    ws_link_dir = fullfile('D:\Program Files\Wolfram Research\Mathematica\',MATH_VER,'\SystemFiles\Links\WSTP\DeveloperKit\Windows-x86-64\SystemAdditions\');
    ws_comp_dir = fullfile('D:\Program Files\Wolfram Research\Mathematica\',MATH_VER,'\SystemFiles\Links\WSTP\DeveloperKit\Windows-x86-64\CompilerAdditions');
